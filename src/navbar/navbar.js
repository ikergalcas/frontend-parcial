...
const comprobarConexion = async () => {
  fetch(`https://backend-parcial-git-main-ikergalcas-projects.vercel.app/entidades/conexion/${JSON.parse(localStorage.getItem('objetoToken')).tokenId}/${JSON.parse(localStorage.getItem('objetoToken')).tokenCompleto}`, {
        method: 'GET',
        headers: {
